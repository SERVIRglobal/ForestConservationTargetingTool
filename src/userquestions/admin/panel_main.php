...
?>
  ...
  <tr>
    ...
    <td valign="top" class="righttd">
    <?php 
     $charsets = array('utf-8','utf-16','iso-8859-1','iso-8859-2','iso-8859-3','iso-8859-4','iso-8859-5','iso-8859-6-i','iso-8859-7','iso-8859-8-i','iso-8859-9','iso-8859-10','iso-8859-13','iso-8859-14','iso-8859-15','us-ascii','euc-jp','shift_jis','iso-2022-jp','euc-kr','gb2312','gb18030','big5','tis-620','koi8-r','koi8-u','macintosh','windows-1250','windows-1251','windows-1252','windows-1253','windows-1254','windows-1255','windows-1256','windows-1257');
...
<table>
  ...
  <tr>
    ...
    <td valign="top" class="righttd">
        ...
        Answer: &nbsp;&nbsp;
        <input type="text" name="bottestanswer" size="29" maxlength="20" value="<?php echo $this->VARS['bottestanswer']; ?>" class="input"></fieldset>
    </td>
  </tr>  
  <tr>
    ...
    <td valign="top" class="righttd">
        ...
        Answer: &nbsp;&nbsp;
        <input type="text" name="comment_pass" size="29" value="<?php echo $this->VARS['comment_pass']; ?>" class="input"></fieldset> 
    </td>
  </tr>
  <tr>
